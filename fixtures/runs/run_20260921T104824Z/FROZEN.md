...
Collected 2026-09-21. This is the run we present from, and the only one kept in the repo.

Replay it end to end without touching the network:

    python -m src.pipeline --run-id run_20260921T104824Z

Rebuild the offline page from it:

    python -m web.site --run-id run_20260921T104824Z
